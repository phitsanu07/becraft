...
# /be - Bundled Workflow (Antigravity)
...
```markdown
📚 **Skills Loaded:** smart-routing ✅, memory-system ✅, response-format ✅, contract-first ✅
...
## 📍 ROLE: Orchestrator (from /be command)
...
- `.be/agents/plan-orchestrator.md` — analysis + coordination
- `.be/agents/schema-architect.md` — DB design
- `.be/agents/api-builder.md` — endpoints
- `.be/agents/auth-guard.md` — authn/authz
- `.be/agents/observability.md` — logs/metrics/health
- `.be/agents/test-runner.md` — tests + auto-fix
